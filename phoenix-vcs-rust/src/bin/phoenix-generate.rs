...
fn generate_client_ts_with_emit(protocol: &panproto_schema::Protocol, _name: &str) -> anyhow::Result<String> {
    ...
    b = b.vertex("import_elena", "ImportDecl", Some("import { Elena } from '@elenajs/core';\n\n")).map_err(|e| anyhow::anyhow!(e))?;
    ...
    b = b.vertex("define_welcome", "ExprStmt", Some("WelcomeCard.define();\n")).map_err(|e| anyhow::anyhow!(e))?;
    b = b.vertex("define_todo", "ExprStmt", Some("TodoList.define();\n")).map_err(|e| anyhow::anyhow!(e))?;
    b = b.vertex("define_app", "ExprStmt", Some("ElenaApp.define();\n\n")).map_err(|e| anyhow::anyhow!(e))?;
    b = b.vertex("mount", "ExprStmt", Some("document.body.appendChild(document.createElement('elena-app'));\n")).map_err(|e| anyhow::anyhow!(e))?;
