    ...
    TemplateBundle {
        ...
        files: vec![
            ...
            BundleFile {
                ...
                theory: FormalTheory::ThPythonTextual,
                description: "Main Textual application".to_string(),
            },
            BundleFile {
    ...
    TemplateBundle {
        ...
        files: vec![
            ...
            BundleFile {
                ...
                theory: FormalTheory::ThRust,
                description: "Main Rust application".to_string(),
            },
        ],
        base_deps: vec![],
    }
