...
pub async fn generate_code(
    ...
    // Note: pyproject.toml is generated by template_bundle::generate_bundle using ThPyProject formal theory
    // Do NOT duplicate here - single source of truth in template_bundle.rs
...
// Migration traits using REAL panproto functions
pub mod panproto_migration;
