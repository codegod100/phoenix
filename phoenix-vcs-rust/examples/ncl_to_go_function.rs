//! NCL to Go Function Converter Example
//!
//! Demonstrates converting Nickel (NCL) function definitions to Go code.
//!
//! Run: cargo run --example ncl_to_go_function

use phoenix_vcs::examples::ncl_to_go::{NclFunction, ncl_fn_to_go, generate_go_file};
