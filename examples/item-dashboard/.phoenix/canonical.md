...
## UI Theme - Catppuccin Mocha (1 requirement)
...
## Dashboard Behaviors (3 requirements)
...
## Design System (20 requirements)

- node-9a4e7c3b: use catppuccin mocha aesthetic (soft, rounded, elevated surfaces with warm pastels on dark backgrounds)
...
- node-a7c3f5e8: real-time filtering sorting without page reload
